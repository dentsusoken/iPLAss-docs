...
. 有償版の SDK に同梱されている Enterprise Edition 機能の追加パッケージ `iplass-ee-sample-app-ai-package.zip` を取得します。このパッケージには、Community Edition には含まれない AI 機能のメタデータ（プロンプト定義・データ連携定義）が含まれます。
