...
In addition, MCP Tools for browsing and updating metadata (design-time information) are provided out of the box, supporting AI-driven development with AI agents.
