...
| aiPromptRequestId | %X{aiPromptRequestId} | [.eeonly]#iplass-ee-core# module is applied, output the AI prompt request ID.
| aiDataConnectExecuteId | %X{aiDataConnectExecuteId} | [.eeonly]#iplass-ee-core# module is applied, output the AI Data Connect execution ID.
|===
