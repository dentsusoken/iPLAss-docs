...
| aiPromptRequestId | %X{aiPromptRequestId} | Available when [.eeonly]#iplass-ee-core# module is applied, output the AI prompt request ID.
| aiDataConnectExecuteId | %X{aiDataConnectExecuteId} | Available when [.eeonly]#iplass-ee-core# module is applied, output the AI Data Connect execution ID.
|===
