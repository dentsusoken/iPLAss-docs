...
|===
| Name | Description
| <<index.adoc#AiApplicationPolicyService, [.eeonly]#AiApplicationPolicyService#>> | This service manages application policy settings for AI features.
| <<index.adoc#AiDataConnectService>> | A service for AI data connection.
| <<index.adoc#AiIntegrationService>> | A service for AI integration. This is an integrated service available for data connection and prompts.
| <<index.adoc#AiPromptService>> | A service for AI prompts.
| <<index.adoc#AiSystemPromptService>> | A service for AI system prompts.
...
| <<index.adoc#PdfConversionService, PdfConversionService>> | A service that converts Excel to PDF, used for PDF (PDF_JXLS) output of JXLS reports.
...
| <<index.adoc#MdcRelativeRangeService, [.eeonly]#MdcRelativeRangeService#>> | This is a service for adding your own relative range in the MDC version.
...
| <<index.adoc#SpreadSheetService, [.eeonly]#SpreadSheetService#>> | This is a service for the Spreadsheet function.
|===
...
| <<index.adoc#McpService, McpService>> | The service to manage MCP functionality.
| <<index.adoc#McpToolService, McpToolService>> | The service related to MCP Tool.
|===
