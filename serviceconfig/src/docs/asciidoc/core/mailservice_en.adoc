...
Properties extended with iPLAss.
| mail.customheaderMap | String, in format of Map | Specify the value to be set in the email header in Map format. Set the header name in name and the header value in value. +
Properties extended with iPLAss.
