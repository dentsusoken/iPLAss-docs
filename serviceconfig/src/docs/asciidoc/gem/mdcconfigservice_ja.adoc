...
| fileUploadStatusPollingInterval | int | アップロードのステータスポーリングのインターバル。デフォルト値は10000（10秒）です。
...
<service>
	...
	<property name="fileUploadAsync" value="true"/>

	<!-- ファイルアップロードステータスポーリングのインターバル、指定ミリ秒 -->
