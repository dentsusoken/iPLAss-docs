...
| selectFilterSearchPageSize | int | The number of records retrieved each time by the reference-type. If not specified, the default value is 40.
...
<service>
	...
	<!-- Search results for reference type selection filters -->
