...
| aggregationFileSupportType | AggregationFileSupportType | Aggregation file support type. Specify from `CSV` `EXCEL`. The default value is `CSV`.
| rawDataAggregationFileSupportType | AggregationFileSupportType | Raw data aggregation file support type. Specify from `CSV` `EXCEL`. The default value is `CSV`.
...
<service>
	...
	<!-- Aggregation file support type. CSV, EXCEL -->
	<property name="aggregationFileSupportType" value="CSV" />

	<!-- Raw data aggregation file support type. CSV, EXCEL -->
