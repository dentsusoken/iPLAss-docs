...
| searchResultAutoHeightAdjustMode | AutoHeightAdjustMode | Mode of automatic height adjustment of the table on the search screen. Specify from `FIT_TO_ROW_COUNT` `FIT_TO_VIEWPORT`. The default value is `FIT_TO_ROW_COUNT`.
It can be overwritten by <<../developerguide/genericentitymanager/entityview/index#searchresult_setting, search result settings>> of individual EntityView definitions.
...
| selectFilterSearchPageSizeDefault | int | The number of records retrieved each time by the reference-type selectFilter. The default value is 40.
| spreadsheetSelectCandidateLimit | int | The maximum number of reference candidates to be pre-fetched in the Spreadsheet SELECT mode. The default value is 1000.
...
| showUserTaskSearchCondResetButton| boolean | Whether to display the reset button on the workflow task list screen. The default value is true.
| showUserTaskPulldownPleaseSelectLabel| boolean | Whether to display the label "Please select" when no selection is made in the dropdown on the workflow task list screen. The default value is true.
|===
...
<service>
	...
	<!-- Mode of automatic height adjustment of the table on the search screen -->
	<property name="searchResultAutoHeightAdjustMode" value="FIT_TO_ROW_COUNT"/>
	...
	<!-- Whether to display the reset button on the workflow task search screen -->
	<property name="showUserTaskSearchCondResetButton" value="true"/>

	<!-- Whether to display the "Please select" dropdown on the workflow task search screen -->
	...
	<!-- The maximum number of reference candidates to be pre-fetched in the Spreadsheet SELECT mode -->
	<property name="spreadsheetSelectCandidateLimit" value="1000" />
</service>
----