...
| classPropertySchema | <<openapiservice_ClassPropertySchema>>, Multiple | The class-property schema definitions used when exporting OpenAPI.
|===

[[openapiservice_ClassPropertySchema]]
.ClassPropertySchema
class is specified as org.iplass.mtp.impl.webapi.openapi.schema.ClassPropertySchema.
...
<service>
    ...
    <property name="classPropertySchema" class="org.iplass.mtp.impl.webapi.openapi.schema.ClassPropertySchema">
