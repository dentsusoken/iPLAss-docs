...
| defaultIgnoreNotExistsProperty | boolean | Default value for ignoring properties not defined in the Entity during upload. Default value is `false`.
|===
...
<service>
	...
	<!--
		Default value for ignoring properties not defined in the Entity during upload.
	-->
