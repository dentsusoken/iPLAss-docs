...
| aiPromptRequestId | %X{aiPromptRequestId} | [.eeonly]#iplass-ee-core# モジュールの利用時、AIプロンプトリクエストのIDを出力
| aiDataConnectExecuteId | %X{aiDataConnectExecuteId} | [.eeonly]#iplass-ee-core# モジュールの利用時、AI Data Connectの実行IDを出力
|===
