...
|===
| 名前 | 概要
| <<index.adoc#AiApplicationPolicyService, [.eeonly]#AiApplicationPolicyService#>> | AI機能におけるアプリケーションポリシー設定を管理するサービスです。
| <<index.adoc#AiDataConnectService>> | AIデータ連携のサービスです。
| <<index.adoc#AiIntegrationService>> | AI統合のサービスです。データ連携、プロンプトで利用可能な統合的なサービスです。
| <<index.adoc#AiPromptService>> | AIプロンプトのサービスです。
| <<index.adoc#AiSystemPromptService>> | AIシステムプロンプトのサービスです。
...
| <<index.adoc#PdfConversionService, PdfConversionService>> | JXLS帳票のPDF（PDF_JXLS）出力で利用する、ExcelからPDFへの変換サービスです。
...
| <<index.adoc#MdcRelativeRangeService, [.eeonly]#MdcRelativeRangeService#>> | MDC版の相対範囲を独自に追加するためのサービスです。
...
| <<index.adoc#SpreadSheetService, [.eeonly]#SpreadSheetService#>> | Spreadsheet機能のサービスです。
|===
...
| <<index.adoc#McpService, McpService>> | MCP機能を管理するサービスです。
| <<index.adoc#McpToolService, McpToolService>> | MCP Tool に関するサービスです。
|===
