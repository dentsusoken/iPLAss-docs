...
[[aws2_AWSHttpSender]]
.AWSHttpSender(AWSHttpSenderBuilder)
Specify the class org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSenderBuilder. +
Use the AWSHttpSenderBuilder, a feature exclusive to iPLAss 3.2, to generate an instance of org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSender. +
When applying to service-config, set it in the builder attribute. 
...
[CAUTION]
====
Do not set org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSender in the class attribute of service-config in iPLAss 3.2.
...
<property name="meterRegistryFactory" class="org.iplass.mtp.impl.micrometer.registry.elastic.ElasticMeterRegistryFactory">
	<property name="httpSender" builder="org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSenderBuilder"> <1>
		: 
	</property>
</property>
...
<property name="meterRegistryFactory" class="org.iplass.mtp.impl.micrometer.registry.elastic.ElasticMeterRegistryFactory">
	<property name="httpSender" class="org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSender"> <2>
		: 
	</property>
</property>
----
<1> Use the builder attribute.
...
<service>
	...
	-->
		...
		-->
		<!-- Example of using AWS SDK for Java 2.x. Depends on org.iplass.mtp.impl.awsv2.AWSSetting. Set it to the builder attribute. -->
		<!--
		<property name="httpSender" builder="org.iplass.mtp.impl.micrometer.awsv2.AWSHttpSenderBuilder">
			<property name="serviceName" value="es" />
			<property name="region" value="yourESRegion" />
