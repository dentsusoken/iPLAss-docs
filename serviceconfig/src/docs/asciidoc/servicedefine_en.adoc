...
| [.eeonly]#/mcp-service-config.xml# | The default config files for mcp module. Can be used by Enterprise Edition.
|===
...
The relevant characters in XML comments also need to be escaped.
