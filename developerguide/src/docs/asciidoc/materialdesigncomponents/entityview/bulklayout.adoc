...
mdcProxy:: MBulkViewコンポーネントインスタンスへのプロキシオブジェクト
mdcComponent:: MBulkViewコンポーネントが `defineExpose` で公開しているオブジェクト
====
...
|SELECTFILTER
|選択フィルターの設定を行います。
詳細は<<bulklayout_reference_property_editor_select_filter_config, 選択フィルター設定>>を参照してください。

|参照コンボ設定
|REFCOMBO
|参照コンボの設定を行います。
詳細は<<bulklayout_reference_property_editor_reference_combo_config, 参照コンボ設定>>を参照してください。
...
[[bulklayout_reference_property_editor_select_filter_config]]
===== 選択フィルター設定
