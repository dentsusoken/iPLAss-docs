...
以下の各設定項目の説明については<<../../developerguide/workflow/index.adoc#ref_usertask_assign_rule,リンク>>を参照してください。
+
...
今回は承認だけ設定します。
詳しい説明は<<../../developerguide/workflow/index.adoc#ref_usertask_result_status,リンク>>を参照してください。
+
