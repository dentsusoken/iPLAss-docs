...
| <<../../developerguide/workflow/index#ref_history_log,historyLogging>> | true
|===
...
Please refer to <<../../developerguide/workflow/index#ref_usertask_assign_rule,the workflow documentation>> for descriptions of each of the following settings.
+
...
For detailed instructions, please refer to <<../../developerguide/workflow/index#ref_usertask_result_status,the workflow documentation>>.
+
