...
The `topview` s (the view definition named "topview") that were added earlier are now available in the `ResultList` View and `Detail Action View`, so please select them.

image::images/topview_searchresultlistdialog-topview_en.png[]

In this state TopView　save and display the Top screen.
