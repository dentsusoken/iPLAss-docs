...
+
A tenant is a mechanism for securing an “independent usage domain” for each organization or environment. +
With iPLAss, this tenant allows for the complete separation and operation of data, settings, user management, and more. +
Here, you will enter the information for your first tenant to begin using iPLAss. +
+
