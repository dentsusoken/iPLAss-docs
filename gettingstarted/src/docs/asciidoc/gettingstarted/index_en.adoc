...
+
Tenant is like the conceptual division of the server. +
This tenant allows you to operate data, settings, user management, and other functions completely separately. +
Here, enter the information for the first tenant to use iPLAss.
+
