...
+
A tenant provides an “independent usage domain” for each organization or environment. +
With iPLAss, tenants provide complete separation of data, configuration, user management, and more between organizations and environments. +
Here, you will enter the information for the first tenant that will be used with iPLAss. +
+
