...
+
A tenant is a logical partition (isolation unit) in iPLAss. +
It separates application data, settings, user management, and other functions for each organization or environment. +
Here, enter the information for the first tenant that will use iPLAss.
+
